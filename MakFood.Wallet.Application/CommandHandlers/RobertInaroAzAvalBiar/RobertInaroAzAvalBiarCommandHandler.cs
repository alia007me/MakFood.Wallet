...
namespace MakFood.Wallet.Application.CommandHandlers.RobertInaroAzAvalBiar
{
    ...
    {
        private readonly IChargeWalletRepository _walletRepository;
        private readonly IReplyEventRepository _replyEventRepository;

        public RobertInaroAzAvalBiarCommandHandler(IChargeWalletRepository walletRepository, IReplyEventRepository replyEventRepository)
        {
